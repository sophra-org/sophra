  ...
  describe("Adaptation Suggestions API", () => {
    ...
    describe("POST /api/nous/adapt/suggest", () => {
      it("should return suggestions for valid query", async () => {
        ...
        vi.mocked(
          mockPrisma.adaptationSuggestion.findMany
        ...
        vi.mocked(mockPrisma.adaptationSuggestion.findMany).mockResolvedValue(
          mockSuggestion
        );
      ...
      it("should handle database errors", async () => {
        ...
        vi.mocked(mockPrisma.adaptationSuggestion.findMany).mockRejectedValue(
          error
        );
