...
path.join(process.cwd(), "../../prisma/test-analyzer-client/query_engine-windows.dll.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "../../prisma/test-analyzer-client/schema.prisma")
